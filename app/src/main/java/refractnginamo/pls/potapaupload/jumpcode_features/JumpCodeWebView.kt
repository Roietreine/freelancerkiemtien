package refractnginamo.pls.potapaupload.jumpcode_features
...
import refractnginamo.pls.potapaupload.databinding.CustomWebViewBinding
import java.io.File
...
class JumpCodeWebView (context: Context, attrs: AttributeSet):  WebView(context,attrs){

    private val binding: CustomWebViewBinding =
    ...
    private var activityResultMultiplePermission = (context as AppCompatActivity).registerForActivityResult(
